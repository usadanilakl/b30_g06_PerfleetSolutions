...
public class HowToUsePinbar_DK_StepDef {
    ...
    public void user_click_the_learn_how_to_use_this_space_link_on_the_homepage_users_should_see(List<String> expectedElements) {
        ...
        assertEquals("image path is wrong", "/bundles/oronavigation/images/pinbar-location.jpg", howPage.getImage().getAttribute("src"));
    }
